    ...
    jQuery.getJSON('http://cdn.gdnonline.com/homenews?jsoncallback=?', function (data) {
        ...
        jQuery.each(data, function (key, value) {
            ...
            if (categoryname != data[key].category) {
                ...
                contenthtml += '<div class="timgwrap"><img onclick="javascript:window.location.href=\'details.html?id=' + data[key].article_id + ' \'"  class="lazy" data-src="http://www.gdnonline.com/gdnimages/' + data[key].mime_type_source.replace('.jpg', '_t.jpg').replace('.JPG', '_t.jpg') + '" alt="img" class="timg "></div> ';
