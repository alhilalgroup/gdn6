    ...
    jQuery.getJSON('http://cdn.gdnonline.com/homenews?jsoncallback=?', function (data) {
        ...
        jQuery.each(data, function (key, value) {
            ...
            if (categoryname != data[key].category) {
                ...
                if (screen.width < 768) {
                    contenthtml += '<div   class="sliderrow"><div class="sliderpicwrap"><img   onclick="javascript:window.location.href=\'details.html?id=' + data[key].article_id + ' \'"    class="sliderpic lazy" data-src="http://www.gdnonline.com/gdnimages/' + data[key].mime_type_source.replace(".jpg", "_t.jpg").replace(".JPG", "_t.jpg") + '" /></div>';
                }
                else {
                    contenthtml += '<div   class="sliderrow"><div class="sliderpicwrap"><img   onclick="javascript:window.location.href=\'details.html?id=' + data[key].article_id + ' \'"    class="sliderpic lazy" data-src="http://www.gdnonline.com/gdnimages/' + data[key].mime_type_source + '" /></div>';
                }
                ...
                contenthtml += '<div class="timgwrap"><img style="width:130px;height:70px;"  onclick="javascript:window.location.href=\'details.html?id=' + data[key].article_id + ' \'"  class="lazy timg" data-src="http://www.gdnonline.com/gdnimages/' + data[key].mime_type_source.replace('.jpg', '_t.jpg').replace('.JPG', '_t.jpg') + '" alt="img" ></div> ';
